...
if selected_nutrient != "None Selected":
    ...
    fig_cal = px.scatter(
        ...
        x=selected_nutrient,
        y="Calories per 100g",
        title=f"{title_nutrient} vs {professional_label('Calories per 100g')} by Food Category",
        color="cluster",
        hover_data={
            "Food Category": True,
    ...
    if selected_category != "None Selected":
        ...
        fig_cal = px.scatter(
            ...
            x=selected_nutrient,
            y="Calories per 100g",
            title=f"{title_nutrient} vs {professional_label('Calories per 100g')} by Food Subcategory",
            color="cluster",
            hover_data={
