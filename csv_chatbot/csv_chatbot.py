...
if not os.path.exists(footer_path):
    fallback_url = "https://raw.githubusercontent.com/yildiramdsa/nutrient_composition_of_common_foods_in_canada_analyzing_the_canadian_nutrient_file/main/csv_chatbot/footer.png"
    st.image(fallback_url, use_container_width=True)
else:
